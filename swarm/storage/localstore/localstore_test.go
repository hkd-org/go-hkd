...
import (
	...
	ch "github.com/hkd-org/go-hkd/swarm/chunk"
	"github.com/hkd-org/go-hkd/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/hkd-org/go-hkd/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
