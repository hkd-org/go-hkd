...
[![Travis](https://travis-ci.org/hkd/go-hkd.svg?branch=master)](https://travis-ci.org/hkd/go-hkd)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/hkd-org/go-hkd

    go install github.com/hkd-org/go-hkd/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/hkd-org/go-hkd`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/hkd-org/go-hkd
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/hkd-org/go-hkd/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/hkd-org/go-hkd/wiki/Code-Review-Guidelines).
