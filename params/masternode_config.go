...
import (
	...
	"github.com/hkd-org/go-hkd/common/bytesutil"
)
...
type MasternodeChainConfig struct {
	...
	TestnetContractEndpoint   string        // TestnetContractEndpoint to fetch the contract address of the Hkd testnet.
...
var defaultMasternodeConfig = &MasternodeChainConfig{
	...
	// Hkd Masternode sharding constants.
	...
	// Testnet misc values.
	TestnetContractEndpoint: "https://www.hkd.org/contract", // defines an http endpoint to fetch the testnet contract addr.
}
