...
// HkdMin is a free data retrieval call binding the contract method 0xc808021c.
//
// Solidity: function hkdMin() constant returns(uint256)
func (_Contract *ContractCaller) HkdMin(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "hkdMin")
	return *ret0, err
}
...
//
// Solidity: function hkdMin() constant returns(uint256)
func (_Contract *ContractSession) HkdMin() (*big.Int, error) {
	return _Contract.Contract.HkdMin(&_Contract.CallOpts)
}

// HkdMin is a free data retrieval call binding the contract method 0xc808021c.
//
// Solidity: function hkdMin() constant returns(uint256)
func (_Contract *ContractCallerSession) HkdMin() (*big.Int, error) {
	return _Contract.Contract.HkdMin(&_Contract.CallOpts)
}

// HkdPerNode is a free data retrieval call binding the contract method 0xff5ecad2.
//
// Solidity: function hkdPerNode() constant returns(uint256)
func (_Contract *ContractCaller) HkdPerNode(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "hkdPerNode")
	return *ret0, err
}
...
//
// Solidity: function hkdPerNode() constant returns(uint256)
func (_Contract *ContractSession) HkdPerNode() (*big.Int, error) {
	return _Contract.Contract.HkdPerNode(&_Contract.CallOpts)
}

// HkdPerNode is a free data retrieval call binding the contract method 0xff5ecad2.
//
// Solidity: function hkdPerNode() constant returns(uint256)
func (_Contract *ContractCallerSession) HkdPerNode() (*big.Int, error) {
	return _Contract.Contract.HkdPerNode(&_Contract.CallOpts)
}
